...
* `/prompts`: Full text of prompt templates used for causal reasoning.
...
To ensure the scientific rigor and reproducibility of our experiments, the following setup was used:
...
## 📝 Prompt Design & Logic
The prompt design follows the methodology proposed by **Lee et al.**.
...
We replaced internal data headers with descriptive full names to maximize the LLM's semantic reasoning capability.
